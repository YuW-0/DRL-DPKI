...
if __name__ == "__main__":
    ...
    try:
        ...
        os.makedirs('/mnt/data/wy2024/models_ablation_no_slidewindow', exist_ok=True)
        
        # Save state_dicts for policy/target networks (recommended)
        torch.save(agent.policy_net.state_dict(), '/mnt/data/wy2024/models_ablation_no_slidewindow/policy_net_state_dict.pth')
        torch.save(agent.target_net.state_dict(), '/mnt/data/wy2024/models_ablation_no_slidewindow/target_net_state_dict.pth')
        
        # Save full models (fallback)
        torch.save(agent.policy_net, '/mnt/data/wy2024/models_ablation_no_slidewindow/policy_net_complete.pth')
        torch.save(agent.target_net, '/mnt/data/wy2024/models_ablation_no_slidewindow/target_net_complete.pth')
        ...
        torch.save(model_info, '/mnt/data/wy2024/models_ablation_no_slidewindow/model_info.pth')
        
        print("Model saved successfully.")
        print("   - Policy net state_dict: /mnt/data/wy2024/models_ablation_no_slidewindow/policy_net_state_dict.pth")
        print("   - Target net state_dict: /mnt/data/wy2024/models_ablation_no_slidewindow/target_net_state_dict.pth")
        print("   - Policy net (full): /mnt/data/wy2024/models_ablation_no_slidewindow/policy_net_complete.pth")
        print("   - Target net (full): /mnt/data/wy2024/models_ablation_no_slidewindow/target_net_complete.pth")
        print("   - Model metadata: /mnt/data/wy2024/models_ablation_no_slidewindow/model_info.pth")
